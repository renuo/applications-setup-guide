...
* Start a new Rails project using `rails new [project-name] --database=postgresql --no-skip-test --skip-sprockets --webpacker` where the `project-name` is exactly the one you chose before.

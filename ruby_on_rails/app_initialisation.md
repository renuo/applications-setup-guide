...
```
rails new [project-name] --database=postgresql --skip-ci --no-skip-test --skip-action-mailbox -m https://raw.githubusercontent.com/renuo/applications-setup-guide/main/ruby_on_rails/template.rb
```
